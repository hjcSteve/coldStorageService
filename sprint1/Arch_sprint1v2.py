...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     serviceaccessgui >> Edge(color='magenta', style='solid', decorate='true', label='<dischargefood<font color="darkgreen"> serviceterminated</font> &nbsp; storerequest<font color="darkgreen"> requestaccepted requestdenied</font> &nbsp; >',  fontcolor='magenta') >> coldstorageservice
