...
with Diagram('coldstorageservice_analArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     transporttrolley >> Edge(color='blue', style='solid',  decorate='true', label='<disengage &nbsp; >',  fontcolor='blue') >> basicrobot
