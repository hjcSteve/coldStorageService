...
public class ServiceAccesGUI_test {
    ...
    ServiceConnectionManager serviceConnectionManager = new ServiceConnectionManager(accessgui, "handler", "coldstorageservice");
 ...
 */
    ...
    public void test_dischargefood_ok() {
        ...
        System.out.println("test_dischargefood_ok-- storerequest("+weight+","+reqid1+")");
        boolean res = response.isReply() && response.msgContent().contains("ticketAccepted");
        Assertions.assertTrue(res);
        System.out.println("test_dischargefood_ok-- ticketAccepted ok (res="+res+")");
        String ticket = accessgui.getValue(response.msgContent());
        response = serviceConnectionManager.dischargefood(ticket,reqid1);
        System.out.println("test_dischargefood_ok-- dischargefood("+weight+","+reqid1+")");
        System.out.println(response.msgContent());
        boolean res2 = response.isReply() && response.msgContent().contains("replyChargeTaken");
    ...
    public void test_dischargefood_ko() {
        ...
        IApplMessage response = serviceConnectionManager.dischargefood(ticketNum,reqid1);
        boolean res = response.isReply() && response.msgContent().contains("ticketDenied");
        Assertions.assertTrue(res);
    ...
    public void test_storerequest_ok() throws InterruptedException {
        ...
        System.out.println("test_storerequest_ok: ticket num= " + accessgui.getValue(response.msgContent()));
    }
    ...
    public void test_storerequest_ko() throws InterruptedException {
        ...
        boolean res = response.isReply() && response.msgContent().contains("replyTicketExpired");
        Assertions.assertTrue(res);
        System.out.println("test_storerequest_ko: ticket replyTicketExpired (res="+res+")");
    }
   ...
   public void test_coda_tickets() throws InterruptedException {
       ...
       boolean res = resp1.isReply() && resp1.msgContent().contains("ticketAccepted");
       Assertions.assertTrue(res);
       ...
       String weight="10";
       IApplMessage second_store_response = serviceConnectionManager.storerequest(weight,reqid2);
       boolean res2 = resp1.isReply() && resp1.msgContent().contains("ticketAccepted");
       Assertions.assertTrue(res2);
       ...
       IApplMessage replyCharge1 = serviceConnectionManager.dischargefood(ticket1,reqid1);
       boolean res3 = replyCharge1.isReply() && replyCharge1.msgContent().contains("replyChargeTaken");
       Assertions.assertTrue(res3);
       System.out.println(("test_coda_tickets: dischargefood con ticket1 -> replyChargeTaken"));

       System.out.println("test_coda_tickets: storerequest numero 2");
       System.out.println("test_coda_tickets: dischargefood con ticket2");
       IApplMessage replyCharge2 = serviceConnectionManager.dischargefood(ticket2,reqid2);
       boolean res4 = replyCharge2.isReply() && replyCharge2.msgContent().contains("replyTicketExpired");
       Assertions.assertTrue(res4);
       System.out.println(("test_coda_tickets: dischargefood con ticket1 -> replyTicketExpired"));
   }
